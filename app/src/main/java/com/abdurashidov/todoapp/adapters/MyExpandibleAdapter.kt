...
import com.abdurashidov.todoapp.databinding.ExpItemChildBinding
import com.abdurashidov.todoapp.databinding.ExpItemGroupBinding
...
class MyExpandibleAdapter( private val map:HashMap<String, ArrayList<Todo>>, private val groupList:ArrayList<String>)
    ...
    override fun getGroupView(
        ...
        val itemGroup=ExpItemGroupBinding.inflate(LayoutInflater.from(parent?.context), parent, false)
    ...
    override fun getChildView(
        ...
        val itemChild=ExpItemChildBinding.inflate(LayoutInflater.from(parent?.context), parent, false)
